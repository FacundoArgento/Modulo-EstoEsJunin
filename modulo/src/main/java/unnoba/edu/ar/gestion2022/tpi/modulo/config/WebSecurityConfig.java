    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/users", "/users/new", "/form", "/listado","/plomeros/*","/plomeros","/gasistas","/gasistas/*","/albaniles","/electricistas", "/albaniles/*","/electricistas/*", "/index", "/", "/error","/seccion","/seccion/*", "/seccion-form").permitAll()
                    .antMatchers(HttpMethod.POST, "/users/new", "/seccion/new").permitAll()
